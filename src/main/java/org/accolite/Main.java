...
public class Main {
    public static void main(String[] args) {
        ...
        PlayerStatistics highestScorer = statisticsSet.stream().sorted(Comparator.comparing(PlayerStatistics::getHighestScore)).collect(Collectors.toList()).get(statisticsSet.size()-1);
        System.out.println(highestScorer.getPlayerName()+" "+ highestScorer.getHighestScore());
        System.out.println();
        PlayerStatistics secondHighestScorer = statisticsSet.stream().sorted(Comparator.comparing(PlayerStatistics::getHighestScore)).collect(Collectors.toList()).get(statisticsSet.size()-2);
        System.out.println(secondHighestScorer.getPlayerName()+" "+secondHighestScorer.getHighestScore());
        System.out.println();
        PlayerStatistics leastScorer = statisticsSet.stream().sorted(Comparator.comparing(PlayerStatistics::getHighestScore)).findFirst().get();
        System.out.println(leastScorer.getPlayerName()+" "+leastScorer.getHighestScore());
        System.out.println();
        PlayerStatistics oldestPlayer = statisticsSet.stream().sorted(Comparator.comparing(PlayerStatistics::getBirthDate)).collect(Collectors.toList()).get(0);
        ...
        groupPlayers.forEach(
                (x,y)->{
                    System.out.println(x*10+"'s");
                    System.out.println(y.stream().sorted(Comparator.comparing(PlayerStatistics::getScores)).collect(Collectors.toList()).get(y.size()-1));
                }
        );
        System.out.println();
        System.out.println("Highest Strike Rate");
        System.out.println(statisticsSet.stream().sorted(Comparator.comparing(PlayerStatistics::getStrikeRate)).collect(Collectors.toList()).get(statisticsSet.size()-1));
        System.out.println();
        ...
        System.out.println(statisticsSet.stream().sorted(Comparator.comparing(playerStatistics -> playerStatistics.getWicketTaken()/ playerStatistics.getMatchesPlayed())).collect(Collectors.toList()).get(statisticsSet.size()-1));
        System.out.println();
